...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($email) && !empty($password) && !empty($role)) {
        // Periksa apakah email sudah ada di salah satu tabel
        $stmt_check = $conn->prepare("SELECT email FROM user_admin WHERE email = ? UNION SELECT email FROM user_admin_plain WHERE email = ?");
